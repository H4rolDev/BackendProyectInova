    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Acceso total a todas las funcionalidades.", true, "Trabajador" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Laptop HP Pavilion con procesador Intel Core i5 y 8GB de RAM.", true, 12, 1, 1, "hp_pavilion_15.jpg", "15-eh2021nr", "HP Pavilion 15", 3500.00m, 20, 14, 500.00m },
                    { 2, "Laptop Dell XPS 13 con pantalla InfinityEdge y procesador Intel Core i7.", true, 12, 1, 3, "dell_xps_13.jpg", "XPS 13 9310", "Dell XPS 13", 4500.00m, 15, 13, 600.00m },
                    { 3, "Mouse inalámbrico Logitech MX Master 3 con control preciso.", true, 24, 2, 2, "logitech_mx_master_3.jpg", "MX Master 3", "Logitech MX Master 3", 150.00m, 50, 13, 20.00m },
                    { 4, "Teclado mecánico Razer BlackWidow V3 con retroiluminación RGB.", true, 12, 3, 6, "razer_blackwidow_v3.jpg", "BlackWidow V3", "Razer BlackWidow V3", 200.00m, 25, 15, 30.00m }
                });
